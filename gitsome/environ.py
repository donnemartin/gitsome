...
from gitsome.tools import TERM_COLORS, ON_WINDOWS, ON_MAC, ON_LINUX, string_types, \
...
from gitsome.dirstack import _get_cwd
...
DEFAULT_PROMPT = ('{BOLD_YELLOW}{user} '
                  '{BOLD_WHITE}at '
...
BASE_ENV = {
    'GITSOME_VERSION': GITSOME_VERSION,
    'INDENT': '    ',
